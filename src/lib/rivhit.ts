...
export const rivhit = {
  customers: {
    ...
    create: (payload: unknown) => api.post("/Customer.New", payload),
    update: (customer_id: number, payload: Record<string, unknown>) => api.post("/Customer.Update", { customer_id, ...payload }),
  ...
  items: {
    ...
    create: (payload: Record<string, unknown>) => api.post("/Item.New", payload),
    update: (item_id: number, payload: Record<string, unknown>) => api.post("/Item.Update", { item_id, ...payload }),
  ...
  documents: {
    create: (payload: Record<string, unknown>) => api.post("/Document.New", payload),
    types: (document_type?: number) =>
      api.post("/Document.TypeList", document_type ? { document_type } : {}),
    list: (filters: Record<string, unknown> = {}) => api.post("/Document.List", filters),
  },
  receipts: {
    create: (payload: Record<string, unknown>) => api.post("/Receipt.New", payload),
    types: () => api.post("/Receipt.TypeList", {}),
    list: (filters: Record<string, unknown> = {}) => api.post("/Receipt.List", filters),
  },
  accounting: {
